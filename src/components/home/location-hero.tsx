...
export function LocationHero({ locationName }: { locationName: string }) {
    return (
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0">
                <img
                    src={IMAGES.hero}
                    alt={`Luxury home interior in ${locationName}`}
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
                ...
                >
                    Elevating Homes <br className="hidden md:block" />
                    in {locationName}
                </motion.h1>
                ...
                >
                    Discover elite painting and exclusive remodeling services tailored for discerning homeowners in the {locationName} area.
                </motion.p>
